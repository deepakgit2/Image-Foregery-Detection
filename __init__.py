...
# similar to jpeg_read function in matlab
def image_data(im_name):
	obj=jpeg(im_name)
	id={  'quant_tables':[ obj.getQMatrix("Y"), obj.getQMatrix("Cb") ], 'coef_arrays':[obj.getCoefMatrix('Y'), obj.getCoefMatrix('Cb'), obj.getCoefMatrix('Cr') ] , 
	      'comp_info':[obj.comp_info[0] , obj.comp_info[1] , obj.comp_info[2]] }
	return id
